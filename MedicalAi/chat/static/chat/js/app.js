...
function updateUIForAuthStatus(isSignedIn, userName) {
    ...
    if (profileDropdown) {
        profileDropdown.innerHTML = isSignedIn 
            ...
            : `<a href="/chat/signin.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">Sign In</a>
               <a href="/chat/index.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">Sign Up</a>`;
    }
...
function loadConversationHistory() {
    ...
    conversations.forEach(conversation => {
        ...
        html += `
            <a href="#" class="conversation-item flex items-center justify-between px-3 py-2 text-sm rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-900 dark:text-white ${activeClass}" data-id="${conversation.id}">
...
function signOut() {
    ...
    localStorage.removeItem('authToken'); // Ensure token is cleared on logout
